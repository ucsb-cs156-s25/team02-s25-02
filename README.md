...
|---------------------------|--------------|----------------|
| UCSBDiningCommonsMenuItem |    Xinyan    |    Elskin      |
| UCSBOrganization          |    Jiahua    |     jiahuaren  |
| RecommendationRequest     |    Evania    |   evaniacheng  |
| MenuItemReview            |    Shiyuan   |  andrew200356  |
| HelpRequest               |    Ayala     |   ayalawang    |
| Articles                  |    Mujia     |    mujiaaa     |
